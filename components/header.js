              ...
              <div className='header__left'>
                <InternalLink href='/' classes='header__link-home'>
                  <img
                    ...
                    src={'/static/images/fec-logo.svg' + config.ASSET_VERSION}
                    alt='Logo'
                  />
                </InternalLink>
                ...
                {this.props.menuButtons.map((item, i) => {
                  return (
                    <InternalLink {...item} classes='header__tickets' key={i} />
                  )
                })}

                <label htmlFor='right' className='toggle header__hamburger'>
                  <img
                    className='header__hamburger-bar'
                    src={'/static/images/menu.svg' + config.ASSET_VERSION}
                    alt='Menu'
                  />
                </label>
              </div>
